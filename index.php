    ...
    <div class="slideshow-container">
      ...
      <div class="mySlides fade">
        ...
        <div class="text" style="color:green">
          <h1>AN ONLINE PLATFORM FOR AGRICULTURE</h1>
        </div>
      </div>
      ...
      <div class="mySlides fade">
        ...
        <div class="text" style="color:red">
          <h1>FRESH HANDPICKED PRODUCTS</h1>
        </div>
      </div>
      ...
      <div class="mySlides fade">
        ...
        <div class="text" style="color:white">
          <h1>SAY YES TO ORGANIC PRODUCTS</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <a href="goorganic.html">
          <div class="panel-heading">GO ORGANIC</div>
          <div class="panel-body"><img src="seasonal.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
          <div class="panel-footer">GET ORGANIC DESIRED PRODUCTS</div>
        </a>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-danger">
        <a href="seasonaloffers.html">
          <div class="panel-heading">SEASONAL OFFERS</div>
          <div class="panel-body"><img src="bestoffer.jpg" class="img-responsive" style="width:50%" alt="Image"></div>
          <div class="panel-footer">GET OFFERS ON SEASONAL PRODUCTS</div>
        </a>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-success">
        <a href="boxservices.html">
          <div class="panel-heading">BOX SERVICES</div>
          <div class="panel-body"><img src="boxmain.jpg" class="img-responsive" style="width:90%" alt="Image"></div>
          <div class="panel-footer">BUY MULTTIPLE ITEMS @ CHEAP RATES</div>
        </a>
      </div>
    </div>
  </div>
...
<div id="about" class="container-fluid">
  ...
  <h2>About Us</h2>
  <h4>
    <p>An initiative to built a common platform for producers and customers where both the users can perform their activities with transparency.
...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <h4><strong>MARKET YOUR FARM</strong>
        <p>Get free online exposure to buyers in minutes without needing to design or maintain your own website. Generate a PDF availability list to send to buyers. FarmersWeb buttons let you link to your real time availability from other websites for quick online shopping from your farm.</p>
      </h4>
      <h4><strong>MANAGE DELIVERIES AND LOGISTICS</strong>
        <p>Create your own delivery zones with days of operations, order minimums, and lead times. Coordinate your deliveries by third parties which then receive order details and buyer addresses automatically.</p>
      </h4>
  ...
  <div class="container">
    ...
    <div class="container">
      ...
      <ul class="list-inline">
        ...
        <li><a href="#">E-Agri Advantage</a></li>
